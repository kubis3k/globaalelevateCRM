...
Postup:
0. Přečti `.claude/state/learnings/scout.md`, pokud existuje — ověřené poznatky
   z předchozích průzkumů v tomto projektu (opakující se slepé uličky, kde hledat
   co). Aplikuj je, neopakuj chyby, které tam už jsou zapsané.
...
- <1 řádek: co by měl vědět příští scout, aby nehledal stejnou cestu znovu>
```
