...
import {
  ...
  Settings, Coins, ChevronRight, TrendingUp, Layers, Boxes, Megaphone, Clapperboard,
} from 'lucide-react'
...
export const NAV: NavEntry[] = [
  ...
  { type: 'group', id: 'g-marketing', label: 'Marketing', icon: Megaphone, members: ['logo3d', 'animations'] },
